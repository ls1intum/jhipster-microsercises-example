...
@RestController
@RequestMapping("/api/lecture-kafka")
public class LectureKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LectureKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LectureKafkaResource(KafkaProperties kafkaProperties) {
