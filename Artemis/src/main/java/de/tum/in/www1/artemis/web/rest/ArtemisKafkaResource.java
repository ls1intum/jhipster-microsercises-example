...
@RestController
@RequestMapping("/api/artemis-kafka")
public class ArtemisKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ArtemisKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public ArtemisKafkaResource(KafkaProperties kafkaProperties) {
